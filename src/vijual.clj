...
(defn draw-graph
  ...
  ([edges nodes]
   (->> false
        (layout-graph ascii-dim edges nodes)
...
(comment
  ...
  (def graph-data [[:a :b]
                   ...
                   [:g :e]
                   [:d :e]])
  (anneal (make-undirected graph-data) {})
  (layout-graph ascii-dim graph-data {} false)
  (draw-graph graph-data)
  ...
  (draw-directed-graph graph-data)
